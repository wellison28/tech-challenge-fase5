...
/**
 * Liveness e readiness separados de propósito.
 *
 * `/health` não toca no banco: se ele falhasse por indisponibilidade do Aurora,
 * o orquestrador reiniciaria contêineres saudáveis e pioraria o incidente.
 * `/health/ready` verifica as dependências e é o que o Target Group consulta
 * para decidir se envia tráfego.
 */
